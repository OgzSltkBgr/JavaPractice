...
public class Cons2 {
    public static void main(String[] args) {
        ...
        have it print The line where we call the Rename method in the Main method is immediately then reprint student
        information Create a method named changesurname, this method is "lastname" as parameter get the variable.
